...
public final class ConfigConstants {
	 ...
	 */
	public static final String TASK_MANAGER_TMP_DIR_THRESHOLD_KEY = "taskmanager.tmp.dirs.treshold";
	...
	/**
	 * The default value for the treshold (in MB) of the temporary file directories in the taskmanager.
	 */
	public static final int DEFAULT_TASK_MANAGER_TMP_DIR_TRESHOLD = 100;
